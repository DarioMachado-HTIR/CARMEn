...
class BasicAgent(object):
    ...
    def set_destination(self, end_location, start_location=None, clean_queue=True, draw=False):
        ...
        self._local_planner.set_global_plan(route_trace, clean_queue=clean_queue, draw=draw)
